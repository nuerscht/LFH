...
public class Api extends Controller {
     ...
     * @param since
     *            Get all customer since the passed date (unix timestamp)
    ...
    private static Result getItems(final String id, final String since,
            final Class exType) {
        // Is necessary because type is valid scala type and hence the route
        // definition causes a compilation error
    ...
    private static Date getNewestDateOfItems(final List items,
        ...
        for (final Object item : items) {
            ...
            // Poor performance, must be optimized. Maybe update parent date in
            // db
            Date childDate;
     ...
     *            The id of the order
     * @param since
     *            Get all order since the passed date (unix timestamp)
